...
namespace Lior.Xrm.BusinessUnit.BL.ServiceEventFactory
{
    ...
    public class SundorWF : Observer
    {
        public SundorWF(IOrganizationService service, new_incidentservice target,
        ...
        {
            if (_target.new_AnyCostSundor != null && _target.new_AnyCostSundor.Value)
            {
                return true;
            }
            return false;
        ...
        {
            if (_paramters.new_SundorTeam == null) return null;
            return _paramters.new_SundorTeam.Id;
        }
    }
}

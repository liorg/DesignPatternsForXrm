...
namespace Lior.Xrm.BusinessUnit.BL.ServiceEventFactory
{
    ...
    public class FoodWF : Observer
    {
        public FoodWF(IOrganizationService service, new_incidentservice target,
        ...
        {
            if (_target.new_AnyCostFoodandprovisions != null && _target.new_AnyCostFoodandprovisions.Value)
            {
                return true;
            }
            return false;
        ...
        {
            if (_paramters.new_FoodAndProvisionsTeam == null) return null;
            return _paramters.new_FoodAndProvisionsTeam.Id;
        }
    }
}

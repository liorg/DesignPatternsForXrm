...
namespace Lior.Xrm.BusinessUnit.BL.ServiceEventFactory
{
    ...
    public class CashierWF : Observer
    {
        ...
        {
            if (_target.new_AnyCostCashier != null && _target.new_AnyCostCashier.Value)
            {
                return true;
            }
            return false;
        ...
        {
            if (_paramters.new_CashierTeam == null) return null;
            return _paramters.new_CashierTeam.Id;
        }
    }
}

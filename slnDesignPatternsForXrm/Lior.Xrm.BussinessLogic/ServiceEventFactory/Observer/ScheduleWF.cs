...
namespace Lior.Xrm.BusinessUnit.BL.ServiceEventFactory
{
    ...
    public class ScheduleWF : Observer
    {
        ...
        {
            if (_target.new_AnyCostSchedule != null && _target.new_AnyCostSchedule.Value)
            {
                return true;
            }
            return false;
        ...
        {
            if (_paramters.new_ScheduleTeam == null) return null;
            return _paramters.new_ScheduleTeam.Id;
        }
    }
}
